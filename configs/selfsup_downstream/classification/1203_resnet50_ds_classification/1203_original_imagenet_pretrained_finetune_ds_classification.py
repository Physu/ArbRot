...
optimizer = dict(type='SGD', lr=1, momentum=0.9, weight_decay=0.0005)
optimizer_config = dict()
lr_config = dict(policy='poly', power=0.9, min_lr=0.00001, by_epoch=False)
runner = dict(type='IterBasedRunner', max_iters=180000)
checkpoint_config = dict(by_epoch=False, interval=180000)
evaluation = dict(interval=400000, metric='mIoU')
work_dir = 'newback/imagenet_pretrain_finetune_classification/1203_imagenet_pretrain_finetune_classification'
gpu_ids = range(0, 1)
