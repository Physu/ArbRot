...
work_dir = 'newback/ArbRotPlus/0519_ArbRotPlus_res50_2b8_lr_1e-1_100e_scratch_moco_cosinelr'
...
model = dict(
    ...
    neck=dict(
        ...
        out_channels=64,
        with_avg_pool=True),
    moco_head=dict(type='ContrastiveHead', temperature=0.2, loss_total_weight=0.5),
    # loc_neck=dict(
    #     type='GenerationNeck',
