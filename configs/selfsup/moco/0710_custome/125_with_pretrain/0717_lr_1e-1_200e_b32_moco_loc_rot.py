...
work_dir = 'newback/moco/ablation/0717_lr_1e-1_200e_b32_moco_loc_rot'
...
model = dict(
    ...
    backbone=dict(
        ...
        out_indices=[0, 1, 2, 3],
        norm_cfg=norm_cfg,
        init_cfg=dict(type='Pretrained', checkpoint='/data/lhy/Cascade/mmsegmentation/newback/moco/0513_marc_resnet50_bsize_8_lr_1e-3_100e_from_scratch_moco_loc_rot/res50_mmseg.pth')
    ),
    loc_head=dict(
        type='LocHead0405',
        in_channels=2048,
