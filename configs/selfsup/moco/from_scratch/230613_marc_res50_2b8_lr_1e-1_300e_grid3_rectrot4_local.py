...
work_dir = 'newback/moco/from_scratch/20230613_marc_res50_2b8_lr_1e-1_300e_grid3_rectrot4_local'
...
# optimizer
optimizer = dict(type='SGD', lr=0.01, weight_decay=1e-4, momentum=0.9)  # 2卡时对应学习率0.1，故而8卡 学习率为0.4
