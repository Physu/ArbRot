...
work_dir = 'newback/ArbRotPlusPolicy/0624_ArbRotPlusPolicy_res50_2b8_lr_1e-1_100e_scratch_simclr_locm_rot_rgd_dgr_aug12_type2_cosinelr'
...
model = dict(
    ...
    neck=dict(
        ...
        with_avg_pool=True),
    simclr_head=dict(
        type='ContrastiveHead', temperature=0.1, loss_total_weight=0.5),
    loc_neck=dict(
        type='GenerationNeck',
