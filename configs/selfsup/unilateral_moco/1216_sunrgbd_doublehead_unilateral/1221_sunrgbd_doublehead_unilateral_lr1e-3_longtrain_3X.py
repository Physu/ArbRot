...
runner = dict(type='IterBasedRunner', max_iters=49548*3)  # 300 epoch
...
lr_config = dict(
    ...
    step=[33032+49548*2, 41290+49548*2])                         # 在第200epoch和250epoch时降低学习率
...
log_level = 'INFO'
load_from = None
resume_from = 'newback/unilateral_moco/1217_sunrgbd_rot_and_loc_unilateral/1221_sunrgbd_rot_and_loc_unilateral_lr1e-3_longtrain_3X/latest.pth'
workflow = [('train', 1)]
gpu_ids = range(0, 1)
work_dir = 'newback/unilateral_moco/1217_sunrgbd_rot_and_loc_unilateral/1221_sunrgbd_rot_and_loc_unilateral_lr1e-3_longtrain_3X'