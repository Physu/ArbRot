...
class EncoderDecoderSUNRGBD(BaseSegmentor):
    """Encoder Decoder segmentors.  用来自监督训练部分
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(EncoderDecoderSUNRGBD, self).__init__(init_cfg)
    ...
    def forward_train(self, img, img_metas, gt_semantic_seg, sunrgbd_rotation=None, sunrgbd_location=None):
        ...
        if self.with_auxiliary_head:
            ...
            loss_aux = self._auxiliary_head_forward_train(
                x, img_metas, gt_semantic_seg, sunrgbd_rotation, sunrgbd_location)
