...
class MoCoUnet(BaseSegmentor):
    ...
    4. 另外就是再config当中，返回来的市resnet各阶段的输出参数
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(MoCoUnet, self).__init__(init_cfg)
    ...
    def forward_train(self,
        ...
        img_k_and_depth = torch.cat((img[:, 1, ...].contiguous(), gt_semantic_seg_concat_aug2), dim=1)
        ...
        with torch.no_grad():  # no gradient to keys
            ...
            k, losses_k = self.encoder_k[1](backbone_k, sunrgbd_rotation2, paste_location2,
                                          img_aug2_for_loss_normalization, gt_semantic_seg_aug2_for_loss_normalization,
                                          img_metas)
