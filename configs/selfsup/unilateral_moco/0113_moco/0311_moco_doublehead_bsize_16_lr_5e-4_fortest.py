...
runner = dict(type='IterBasedRunner', max_iters=32297)  # train 10335*100(epoch) /16*2gpu
...
lr_config = dict(
    ...
    step=[19379, 29068])  # 在第0.6*total epch 和0.9* total epoch时降低学习率
...
workflow = [('train', 1)]
gpu_ids = range(0, 1)
work_dir = 'newback/unilateral_moco/0312_moco_doublehead_bsize_16_lr_5e-4_fortest'
