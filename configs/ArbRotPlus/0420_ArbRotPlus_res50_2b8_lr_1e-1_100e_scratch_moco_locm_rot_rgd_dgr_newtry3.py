...
work_dir = 'newback/ArbRotPlus/0420_ArbRotPlus_res50_2b8_lr_1e-1_100e_scratch_moco_locm_rot_rgd_dgr_newtry3'
...
model = dict(
    ...
    rot_head=dict(
        ...
        loss_total_weight=0.9),
    contrastive_head=dict(type='ContrastiveHead', temperature=0.2, loss_total_weight=0.9),
