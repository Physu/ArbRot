...
model = dict(
    type='SUNRGBDMOCOSimpleHeadUnilateralMultiGPU',
...
workflow = [('train', 1)]
gpu_ids = range(0, 1)
work_dir = 'newback/1209_moco_unilateral_loc_multigpu/1209_unilateral_grid2_only_contrastive_lre0_ssim_edge_loss'