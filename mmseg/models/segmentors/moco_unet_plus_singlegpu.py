...
class MoCoUnetPlusSingleGPU(BaseSegmentor):
    """MOCO.
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(MoCoUnetPlusSingleGPU, self).__init__(init_cfg)
    ...
    def forward_train(self,
        ...
        if self.loc_head is not None:
            loss_loc = self._loc_head_forward_train(backbone_q, torch.cat((paste_location1, paste_location1), dim=0), pre_str='loc', img_metas=img_metas)
