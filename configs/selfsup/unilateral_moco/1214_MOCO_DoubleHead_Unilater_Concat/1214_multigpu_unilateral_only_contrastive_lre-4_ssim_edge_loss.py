...
model = dict(
    ...
    #     out_channels=128,
    #     with_avg_pool=True),
    contrastive_head=dict(type='ContrastiveHead', temperature=0.2, contrastive_weight=0.1),
...
# optimizer
optimizer = dict(type='SGD', lr=0.0001, weight_decay=0.0001, momentum=0.9)
...
workflow = [('train', 1)]
gpu_ids = range(0, 1)
work_dir = 'newback/unilateral_moco/1214_MultiGPU_MOCO_Double_Head_unilateral/1214_MultiGPU_unilateral_only_contrastive_lre-4_ssim_edge_loss'