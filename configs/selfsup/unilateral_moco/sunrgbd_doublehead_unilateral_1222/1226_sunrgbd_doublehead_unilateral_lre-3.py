...
runner = dict(type='IterBasedRunner', max_iters=33032*2)  # 5285*100 /8 100 epoch
...
lr_config = dict(
    ...
    step=[19820*2, 29729*2])                  # 在第0.6*total epch 和0.9* total epoch时降低学习率

checkpoint_config = dict(interval=50000*2)
# runtime settings
...
workflow = [('train', 1)]
gpu_ids = range(0, 1)
work_dir = 'newback/unilateral_moco/1226_sunrgbd_rot_and_loc_unilateral/1226_sunrgbd_rot_and_loc_unilateral'