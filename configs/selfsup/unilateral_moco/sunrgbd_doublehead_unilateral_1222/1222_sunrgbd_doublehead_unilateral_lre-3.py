...
# optimizer
optimizer = dict(type='SGD', lr=0.0075, weight_decay=0.0001, momentum=0.9)
optimizer_config = dict()
runner = dict(type='IterBasedRunner', max_iters=44042)  # 5285*100 /12 100 epoch
...
lr_config = dict(
    ...
    step=[26425, 39638])                  # 在第0.6*total epch 和0.9* total epoch时降低学习率
...
workflow = [('train', 1)]
gpu_ids = range(0, 1)
work_dir = 'newback/unilateral_moco/1217_sunrgbd_rot_and_loc_unilateral/1217_sunrgbd_rot_and_loc_unilateral'