...
work_dir = 'newback/moco/from_scratch/0924_res50_bsize_16_lr_1e-1_600e_scratch_grid5_intraloss_taskwight'
...
lr_config = dict(
    ...
    step=[19379**2, 29068*3*2]
)
# runner = dict(type='IterBasedRunner', max_iters=32297*2)
runner = dict(type='IterBasedRunner', max_iters=32297*3*2+500)
