...
work_dir = 'newback/ArbRotPlus/0413_ArbRotPlusPolicy_res50_2b8_lr_1e-1_100e_scratch_moco_loc_rot_rgd_dgr'
...
model = dict(
    ...
    layer='ResNet50',  # 建立了一个字典，所以这里可以通过查询得到所有的层数
    skip_layer=0,
    init_neg_logits=-10,
...
runner = dict(type='IterBasedRunnerWithEpoch', max_iters=33032, curriculum_speed=2)  # 两卡，bs=8，则100epoch iter为33032
