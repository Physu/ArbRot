...
class SUNRGBDMOCODataset(CustomDataset):
    ...
    def __init__(self, split, **kwargs):
        super(SUNRGBDMOCODataset, self).__init__(
    ...
    def prepare_train_img(self, idx):
        ...
        img_aug1 = results['img_aug1_normalization'].data
        img_aug2 = results['img_aug2_normalization'].data
