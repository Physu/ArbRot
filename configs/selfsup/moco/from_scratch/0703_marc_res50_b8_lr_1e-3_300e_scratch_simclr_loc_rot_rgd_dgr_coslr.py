...
work_dir = 'newback/moco/from_scratch/0703_marc_res50_b16_lr_8e-3_300e_from_scratch_simclr_loc_rot_rgd_dgr_coslr'
...
# optimizer
# optimizer = dict(type='SGD', lr=0.008, weight_decay=1e-4, momentum=0.9)
...
#     warmup_ratio=0.0001,
#     step=[14534, 21801])
# runner = dict(type='IterBasedRunner', max_iters=24223)  # bs 128
...
# learning policy
lr_config = dict(policy='CosineAnnealing', min_lr=0.)
runner = dict(type='IterBasedRunner', max_iters=32297*2*3)
