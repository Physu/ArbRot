...
work_dir = 'newback/ArbRotPlus/0401_ArbRotPlus_res50_2b8_lr_1e-1_100e_scratch_moco1e-1_loc8e-1_rot2e-1'
...
model = dict(
    ...
    loc_bbox_head=dict(
        ...
        in_channel=256,
        feat_channel=64,
        loss_center_heatmap=dict(type='GaussianFocalLoss', loss_weight=0.5*0.8),
        loss_wh=dict(type='L1Loss', loss_weight=0.05*0.8),
        loss_offset=dict(type='L1Loss', loss_weight=0.5*0.8)),
    rot_head=dict(
        type='RotHeadPlus',
        in_channels=256,
        num_rot_bins=24,
    ...
    contrastive_head=dict(type='ContrastiveHead', temperature=0.2, loss_total_weight=0.5*0.1),
