...
work_dir = 'newback/moco/from_scratch/1023_res50_4bsize_8_lr_1e-1_300e_scratch_moco_loc_rot_rgd_dgr_intraloss_taskwight'
...
lr_config = dict(
    ...
    step=[19379*3//4, 29068*3//4]
)
# runner = dict(type='IterBasedRunner', max_iters=32297*2)
runner = dict(type='IterBasedRunner', max_iters=32297*3//4)
