...
work_dir = 'newback/moco/from_scratch/1112_res50_4b8_lr_2e-1_300e_simsiam_loc_rot_rgd_dgr_reweight'
...
# optimizer
optimizer = dict(type='SGD', lr=0.1*2, weight_decay=1e-4, momentum=0.9)  # 2卡时对应学习率0.1，故而8卡 学习率为0.4
...
runner = dict(type='IterBasedRunner', max_iters=32297*3)  # 8b8，此时应该是48445
