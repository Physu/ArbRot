...
class SimSiamUnet0623(BaseSegmentor):
    """MOCO.
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(SimSiamUnet0623, self).__init__(init_cfg)
    ...
    def forward_train(self,
        ...
        loss_contrastive = self.contrastive_head(z1, z2)['loss']
        losses.update({'loss_simsiam': loss_contrastive})
