...
class BYOLUnet0623(BaseSegmentor):
    """MOCO.
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(BYOLUnet0623, self).__init__(init_cfg)
    ...
    def forward_train(self,
        ...
        '''
        loss_contrastive = 2. * (
                self.contrastive_head(proj_online_v1, proj_target_v2)['loss'] +
                self.contrastive_head(proj_online_v2, proj_target_v1)['loss'])
        losses.update({'loss_CL' : loss_contrastive})

        # backbone_q = torch.cat((proj_online_v1, proj_online_v2), dim=0)
