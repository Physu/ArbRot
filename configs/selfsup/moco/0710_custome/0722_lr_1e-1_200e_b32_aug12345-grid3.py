...
work_dir = 'newback/moco/ablation/0722_lr_1e-1_200e_b32_aug12345-grid3'
...
model = dict(
    ...
    backbone=dict(
        ...
        out_indices=[0, 1, 2, 3],
        norm_cfg=norm_cfg,
        init_cfg=dict(type='Pretrained', checkpoint='/data/lhy/Cascade/mmsegmentation/newback/moco/from_scratch/augmentation/0719_res50_b16_lr_1e-1_100e_all_reweight_grid3/res50_mmseg.pth')
    ),
    # neck=dict(
