...
work_dir = 'newback/moco/from_scratch/1110_res50_8b8_lr_4e-1_600e_simsiam_loc_rot_rgd_dgr_reweight'
...
# optimizer
optimizer = dict(type='SGD', lr=0.1*4, weight_decay=1e-4, momentum=0.9)  # 2卡时对应学习率0.1，故而8卡 学习率为0.4
...
runner = dict(type='IterBasedRunner', max_iters=32297*3)  # 8b8，此时应该是48445（300epoch）
