...
work_dir = 'newback/moco/ablation/0719_lr_1e-1_200e_b32_all_lr_1e-3_reweight_1e-1_reloss1_1'
...
model = dict(
    ...
    backbone=dict(
        ...
        out_indices=[0, 1, 2, 3],
        norm_cfg=norm_cfg,
        init_cfg=dict(type='Pretrained', checkpoint='/data/lhy/Cascade/mmsegmentation/newback/moco/from_scratch/0718_marc_res50_b16_lr_1e-3_100e_from_scratch_moco_loc_rot_rgd_dgr-equal_reweight_1e-1/res50_mmseg.pth')
    ),
    loc_head=dict(
        type='LocHead0405',
        in_channels=2048,
...
evaluation = dict(interval=33032,
                  metric='mIoU',
                  # save_best='auto',
                  # rule='acc',
