...
work_dir = 'newback/moco/ablation/0720_lr_1e-1_200e_b32_all_lr_1e-3_reweight_5e-2_reloss8_2'
...
model = dict(
    ...
    backbone=dict(
        ...
        out_indices=[0, 1, 2, 3],
        norm_cfg=norm_cfg,
        init_cfg=dict(type='Pretrained', checkpoint='/data/lhy/Cascade/mmsegmentation/newback/moco/from_scratch/0718_marc_res50_b16_lr_1e-3_100e_from_scratch_moco_loc_rot_rgd_dgr_reweight_5e-2/res50_mmseg.pth')
    ),
    loc_head=dict(
        type='LocHead0405',
        in_channels=2048,
