...
work_dir = 'newback/moco/from_scratch/0626_marc_res50_b8_lr_1e-3_300e_byol_loc_rot_rgd_dgr'
...
data = dict(
    ...
    train=dict(
        ...
        pipeline=[
            ...
            dict(
                type='RotateCircleImgAndHHAGenerate',
                resize=256,
                angle=rotation_num,
                grid=grid_num,
                local_or_global='global',
                save_augmented=False,  # 若是可视化增广图像，需要置为true
                log_dir=work_dir),
...
lr_config = dict(
    ...
    warmup_ratio=0.0001,
    step=[800, 900])
runner = dict(type='IterBasedRunner', max_iters=10335)
