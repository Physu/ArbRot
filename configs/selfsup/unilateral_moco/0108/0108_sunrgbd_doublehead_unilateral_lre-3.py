...
runner = dict(type='IterBasedRunner', max_iters=99094)  # 5285*300 /8 300 epoch
...
lr_config = dict(
    ...
    step=[59456, 89184])                  # 在第0.6*total epch 和0.9* total epoch时降低学习率
...
workflow = [('train', 1)]
gpu_ids = range(0, 1)
work_dir = 'newback/unilateral_moco/0108_sunrgbd_rot_and_loc_unilateral/0108'