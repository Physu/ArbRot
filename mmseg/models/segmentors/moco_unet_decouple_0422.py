...
class MoCoUnetDecouple0412(BaseSegmentor):
    """MOCO.
    ...
    8.0412without float weight 这个设定
    9. moco_unet_decouple_0422 这个版本讲个
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(MoCoUnetDecouple0412, self).__init__(init_cfg)
