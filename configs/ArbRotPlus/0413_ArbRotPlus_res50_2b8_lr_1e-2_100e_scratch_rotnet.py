...
work_dir = 'newback/ArbRotPlus/0413_ArbRotPlus_res50_2b8_lr_1e-2_100e_scratch_rotnet'
...
model = dict(
    ...
    rot_head=dict(
        type='RotHead',
        in_channels=2048,
        num_classes=num_rot_classes,
        with_avg_pool=True,
        rot_weight=1.
        ),
    # contrastive_head=dict(type='ContrastiveHead', temperature=0.2, loss_total_weight=0.5),
...
dataset_type = 'SUNRGBDHHADataset'
data_root = 'data/sunrgbd/sunrgbd_trainval'
work_dir = 'newback/ArbRotPlus/0412_ArbRotPlus_res50_2b8_lr_1e-1_100e_scratch_rotnet'
