...
work_dir = 'newback/ArbRotPlus/0317_ArbRotPlus_res50_2b8_lr_1e-1_100e_scratch_moco_loc_rot_rgd_dgr_weight_noaug'
...
model = dict(
    ...
    contrastive_head=dict(type='ContrastiveHead', temperature=0.2, loss_total_weight=1.0),
