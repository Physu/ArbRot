...
work_dir = 'newback/ArbRotPlus/0419_ArbRotPlus_res50_2b8_lr_1e-1_100e_scratch_moco_locm_rot_rgd_dgr_type1'
...
model = dict(
    ...
    contrastive_head=dict(type='ContrastiveHead', temperature=0.2, loss_total_weight=0.1),
