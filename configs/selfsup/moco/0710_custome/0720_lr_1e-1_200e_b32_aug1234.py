...
work_dir = 'newback/moco/ablation/0720_lr_1e-1_200e_b32_aug123'
...
model = dict(
    ...
    backbone=dict(
        ...
        out_indices=[0, 1, 2, 3],
        norm_cfg=norm_cfg,
        init_cfg=dict(type='Pretrained', checkpoint='/mnt/disk7/lhy/Cascade/mmsegmentation-0.14.1/newback/moco/from_scratch/augmentation/0719_res50_b16_lr_1e-1_100e_all_reweight_with_123/res50_mmseg.pth')
    ),
    # neck=dict(
