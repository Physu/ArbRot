...
@PIPELINES.register_module()
class Cls_RandomResizedCrop(object):
...
@PIPELINES.register_module()
class Cls_RandomGrayscale(object):
...
@PIPELINES.register_module()
class Cls_RandomErasing(object):
