...
work_dir = 'newback/ArbRotPlus/0519_ArbRotPolicy_res50_2b8_lr_1e-1_100e_scratch_byol_locm_rot_rgd_dgr_aug12_type2_cosinelr'
...
# curriculum_speed 是
runner = dict(type='IterBasedRunnerWithEpoch', max_iters=33032*3, curriculum_speed=1000, alpha_speed=200)
