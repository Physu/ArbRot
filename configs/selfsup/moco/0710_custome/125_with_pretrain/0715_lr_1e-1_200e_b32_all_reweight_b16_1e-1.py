...
work_dir = 'newback/moco/ablation/0715_lr_1e-3_200e_b32_all_reweight_b16_1e-1'
...
model = dict(
    ...
    backbone=dict(
        ...
        out_indices=[0, 1, 2, 3],
        norm_cfg=norm_cfg,
        init_cfg=dict(type='Pretrained', checkpoint='/data/lhy/Cascade/mmsegmentation/newback/moco/from_scratch/0717_marc_res50_b16_lr_1e-1_100e_from_scratch_moco_loc_rot_rgd_dgr_reweight/res50_mmseg.pth')
    ),
    # neck=dict(
