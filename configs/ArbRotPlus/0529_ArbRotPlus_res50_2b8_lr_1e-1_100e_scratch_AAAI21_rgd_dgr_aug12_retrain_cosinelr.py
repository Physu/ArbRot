...
work_dir = 'newback/ArbRotPlus/0526_ArbRotPlus_res50_2b8_lr_1e-1_100e_scratch_AAAI_rgd_dgr_aug12_retrain_cosinelr'
...
data = dict(
    ...
    train=dict(
        ...
        pipeline=[
            ...
            dict(type='NormalizeImgAndHHA', img_norm_cfg=img_norm_cfg, with_arbrot2=False),
            # dict(type='Normalize', **img_norm_cfg),
            dict(type='DefaultFormatBundle_SUNRGBDHHA'),
            dict(
                type='Collect',
                keys=['img_aug1', 'gt_semantic_seg_aug1',
                    'img_aug2', 'gt_semantic_seg_aug2',
