...
class SUNRGBDMOCO(BaseSegmentor):
    """MOCO. 从moco修改而来，适应deeplabv3的结构
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(SUNRGBDMOCO, self).__init__(init_cfg)
    ...
    def forward_train(self,
        ...
        im_q_backbone = self.encoder_q[0](im_q)  # im_q 和 im_k 是同一张图片的两种增广方式，我们选择其中一种来进行计算contrastive loss
