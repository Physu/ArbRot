...
work_dir = 'newback/moco/0506_marc_resnet50_bsize_16_lr_2e-3_100e_from_scratch_moco_rot_rgd'
...
# optimizer
optimizer = dict(type='SGD', lr=0.002, weight_decay=1e-4, momentum=0.9)
