...
runner = dict(type='IterBasedRunner', max_iters=66063)
# learning policy
...
workflow = [('train', 1)]
gpu_ids = range(0, 1)
work_dir = 'newback/1203_moco_unilateral_multigpu/1203_unilateral_multigpu_grid3_rot4_only_contrastive_lre-1'