...
# optimizer
optimizer = dict(type='SGD', lr=0.00005, weight_decay=0.0001, momentum=0.9)
...
workflow = [('train', 1)]
gpu_ids = range(0, 1)
work_dir = 'newback/unilateral_moco/1212_unilateral_new_design/1212_unilateral_grid2_only_contrastive_lr5e-5_ssim_edge_loss'