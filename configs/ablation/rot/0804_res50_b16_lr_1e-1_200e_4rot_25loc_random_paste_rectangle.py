rotation_num = 4
grid_num = 25
loc_specify = None  # 这个和grid_num相关，取grid中间的位置，取为None的话，表示随机贴回
norm_cfg = dict(type='BN', requires_grad=True)
# norm_cfg = dict(type='SyncBN', requires_grad=True)
dataset_type = 'SUNRGBDHHADataset'
data_root = 'data/sunrgbd/sunrgbd_trainval'
work_dir = 'newback/moco/from_scratch/rot_ablation/0802_200e_4rectangle_rot_random_paste'
