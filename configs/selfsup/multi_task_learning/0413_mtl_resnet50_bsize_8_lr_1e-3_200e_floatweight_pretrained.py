...
work_dir = 'newback/moco/0411_marcl_resnet101_bsize_8_lr_1e-3_200e_floatweight_imagenet'

# 0406 1.用了ssim 2.对于rot res 预测，smoothl1loss改为l1 loss
# 0411 1.将单纯的0-1.0，通过imagenet给归一化到ImageNet那个范围
# 0412 注意这里，重新修改了程序, 适用了floatweight
...
runner = dict(type='IterBasedRunner', max_iters=32297*4+8)
lr_config = dict(
    policy='step',
    warmup='linear',
    warmup_iters=500,
