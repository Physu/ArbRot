...
runner = dict(type='IterBasedRunner', max_iters=33032)  # 训练的总数居5285，100 epoch  即5285*100/16
...
lr_config = dict(
    ...
    step=[19820, 29729])                 # 在第0.6*total epch 和0.9* total epoch时降低学习率
...
workflow = [('train', 1)]
gpu_ids = range(0, 1)
work_dir = 'newback/unilateral_moco/1223_sunrgbd_doublehead_unilateral/ablation_study_of_rotation_'+str(rotation_num)