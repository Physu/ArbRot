...
norm_cfg = dict(type='SyncBN', requires_grad=True)  # 注意这里，和configs/selfsup/unilateral_moco/1214_MOCO_DoubleHead_Unilater_Concat/1215_multigpu_unilateral_only_contrastive_lre-3.py 不同之处就是SyncBN 代替 BN
...
model = dict(
    type='MOCODoubleHeadUnilateralConcatMultiGPU',
...
workflow = [('train', 1)]
gpu_ids = range(0, 1)
work_dir = 'newback/unilateral_moco/1216_MOCO_Double_Head_unilateral/1216_multigpu_unilateral_only_contrastive_lre-3'