...
def cls_cross_entropy(pred,
                  label,
                  weight=None,
                  reduction='mean',
                  avg_factor=None,
                  class_weight=None):
    """Calculate the CrossEntropy loss. borrowed form mmcls/models/losses/cross_entropy_loss
...
def cls_soft_cross_entropy(pred,
                       label,
                       weight=None,
                       reduction='mean',
                       class_weight=None,
...
def cls_binary_cross_entropy(pred,
                         label,
                         weight=None,
                         reduction='mean',
                         avg_factor=None,
...
class ClsCrossEntropyLoss(nn.Module):
    ...
    def __init__(self,
        ...
        if self.use_sigmoid:
            self.cls_criterion = cls_binary_cross_entropy
        elif self.use_soft:
            self.cls_criterion = cls_soft_cross_entropy
        else:
            self.cls_criterion = cls_cross_entropy
