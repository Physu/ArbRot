...
work_dir = 'newback/ArbRotPlus/0602_ArbRotPlus_res50_2b8_lr_1e-1_300e_scratch_simclr_locm_circle_rot_rgd_dgr_aug12_retrain_cosinelr'
...
model = dict(
    ...
    neck=dict(
        ...
        out_channels=64,
        with_avg_pool=True),
    simclr_head=dict(type='ContrastiveHead', temperature=0.1, loss_total_weight=0.5),
    loc_neck=dict(
        type='GenerationNeck',
