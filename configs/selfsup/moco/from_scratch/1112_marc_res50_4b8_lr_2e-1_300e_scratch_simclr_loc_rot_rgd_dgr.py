...
work_dir = 'newback/moco/from_scratch/1112_res50_4b8_lr_2e-1_300e_from_scratch_simclr_loc_rot_rgd_dgr'
...
# optimizer
optimizer = dict(type='SGD', lr=0.1*2, weight_decay=1e-4, momentum=0.9)
...
lr_config = dict(
    ...
    step=[19379*3, 29068*3]
)
# runner = dict(type='IterBasedRunner', max_iters=32297*2)
runner = dict(type='IterBasedRunner', max_iters=32297*3)
