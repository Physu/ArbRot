...
work_dir = 'newback/ArbRotPlus/0305_ArbRotPlus_res50_2b8_lr_5e-4_100e_scratch_moco_loc_rot_rgd_dgr.py'
...
# optimizer
optimizer = dict(type='SGD', lr=0.0005, weight_decay=1e-4, momentum=0.9)
