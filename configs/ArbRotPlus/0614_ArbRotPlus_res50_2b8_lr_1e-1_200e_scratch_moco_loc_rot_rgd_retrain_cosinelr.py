...
work_dir = 'newback/ArbRotPlus/0614_ArbRotPlus_res50_2b8_lr_1e-1_200e_scratch_moco_locm_rot_rgd_retrain_cosinelr'
...
model = dict(
    ...
    loc_bbox_head=dict(
        ...
        loss_circle=dict(with_circle_iou=False, loss_weight=1.),
    ...
    moco_head=dict(type='ContrastiveHead', temperature=0.2, loss_total_weight=0.2),
