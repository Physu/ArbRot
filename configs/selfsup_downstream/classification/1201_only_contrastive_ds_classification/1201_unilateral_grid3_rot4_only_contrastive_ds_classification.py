...
model = dict(
    ...
    pretrained='/mnt/disk7/lhy/Cascade/mmsegmentation-0.14.1/newback/1122only_contrastive/1122_unilateral_grid3_rot4_only_contrastive/latest.pth',
    backbone=dict(
        type='ResNetV1c',
        depth=50,
        num_stages=4,
...
work_dir = 'newback/1201_unilateral_grid3_rot_only_contrastive_ds_classification/1201_unilateral_grid3_rot4_contrastive_rot_ds_classification'
gpu_ids = range(0, 1)
