...
class MoCoUnet0407(BaseSegmentor):
    """MOCO.
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(MoCoUnet0407, self).__init__(init_cfg)
    ...
    def _loss_weight(self):
        ...
        10000\cdot\left(\frac{1}{1+e^{-\left(\frac{x}{20000}\ -3.5\right)}}+1\right)  用于提升权重
        :return:
        '''
        a = torch.tensor(-(self.iters/20000 - 3.5)).cuda()
