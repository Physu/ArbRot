...
work_dir = 'newback/moco/from_scratch/1022_res50_8bsize_8_lr_1e-1_300e_scratch_moco_loc_rot_rgd_dgr_intraloss_taskwight'
...
lr_config = dict(
    ...
    step=[19379*3//8, 29068*3//8]
)
# runner = dict(type='IterBasedRunner', max_iters=32297*2)
runner = dict(type='IterBasedRunner', max_iters=32297*3//8)
