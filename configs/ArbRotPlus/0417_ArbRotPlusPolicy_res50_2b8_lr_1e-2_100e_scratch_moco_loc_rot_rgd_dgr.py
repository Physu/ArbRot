angle_div = None  # None表示 360无限制旋转，180表示2°一份【0，2，4……，358】
num_rot_classes = 12
...
work_dir = 'newback/unilateral_moco/0107_full/0107_full_test'
...
model = dict(
    ...
    loc_bbox_head=dict(
        ...
        in_channel=256,
        feat_channel=64,
        loss_center_heatmap=dict(type='GaussianFocalLoss', loss_weight=0.05),
        loss_wh=dict(type='L1Loss', loss_weight=0.005),
        loss_offset=dict(type='L1Loss', loss_weight=0.05),
    ...
    contrastive_head=dict(type='ContrastiveHead', temperature=0.2, loss_total_weight=0.2),
...
# 两卡，bs=8，则100epoch iter为33032

# curriculum_speed 是
runner = dict(type='IterBasedRunnerWithEpoch', max_iters=10000, curriculum_speed=10, alpha_speed=10)
