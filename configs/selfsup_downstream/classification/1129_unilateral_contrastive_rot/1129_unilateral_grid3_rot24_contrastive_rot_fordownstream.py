...
model = dict(
    ...
    pretrained='/mnt/disk7/lhy/Cascade/mmsegmentation-0.14.1/newback/1128unilateral_contrastive_rot_big/1128_unilateral_grid3_rot24_contrastive_rot_big/latest.pth',
    backbone=dict(
        type='ResNetV1c',
        depth=50,
        num_stages=4,
...
work_dir = 'newback/1129_unilateral_grid3_rot_contrastive_rot_downstream/1129_unilateral_grid3_rot24_contrastive_rot_fordownstream'
gpu_ids = range(0, 1)
