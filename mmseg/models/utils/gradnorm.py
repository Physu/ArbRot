...
class SimpleGradNormalizer:
    def __init__(self, lr_init=0.025, alpha=0.16):
        ...
        # }
        self.loss_weight = {
            "contra_loss": nn.Parameter(torch.tensor([1.], device=default_device)),
            "loc_loss": nn.Parameter(torch.tensor([1.], device=default_device)),
            "rot_loss": nn.Parameter(torch.tensor([1.], device=default_device)),
            "rgd_loss": nn.Parameter(torch.tensor([1.], device=default_device)),
            "dgr_loss": nn.Parameter(torch.tensor([1.], device=default_device)),
        }
