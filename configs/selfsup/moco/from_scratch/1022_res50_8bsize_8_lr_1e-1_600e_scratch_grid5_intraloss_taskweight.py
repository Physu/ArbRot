...
work_dir = 'newback/moco/from_scratch/1022_res50_8bsize_8_lr_1e-1_600e_scratch_moco_loc_rot_rgd_dgr_intraloss_taskwight'
...
# optimizer
optimizer = dict(type='SGD', lr=0.1/8, weight_decay=1e-4, momentum=0.9)
...
lr_config = dict(
    ...
    step=[19379*2*3//8, 29068*2*3//8]
)
# runner = dict(type='IterBasedRunner', max_iters=32297*2)
runner = dict(type='IterBasedRunner', max_iters=32297*2*3//8)
