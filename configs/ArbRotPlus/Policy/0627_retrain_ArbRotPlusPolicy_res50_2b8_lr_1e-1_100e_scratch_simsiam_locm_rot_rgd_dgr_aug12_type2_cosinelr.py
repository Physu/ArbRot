...
work_dir = 'newback/ArbRotPlusPolicy/0627_retrain_ArbRotPlusPolicy_res50_2b8_lr_1e-1_100e_scratch_simsiam_locm_rot_rgd_dgr_aug12_type2_cosinelr'
...
model = dict(
    ...
    work_dir=work_dir,
    policy_path='/data/lhy/Cascade/mmsegmentation/newback/ArbRotPlusPolicy/0624_ArbRotPlusPolicy_res50_2b8_lr_1e-1_100e_scratch_simsiam_locm_rot_rgd_dgr_aug12_type2_cosinelr/policy.pt'
)
data = dict(
    samples_per_gpu=6,
    workers_per_gpu=4,
...
# optimizer
optimizer = dict(type='SGDPolicy', lr=0.1, weight_decay=1e-4, momentum=0.9)
