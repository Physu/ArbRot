...
work_dir = 'newback/ArbRotPlus/0517_ArbRotPlus_res50_2b8_lr_1e-1_100e_scratch_moco_locm_rot_rgd_dgr_aug12_type3_cosinelr'
...
model = dict(
    ...
    loc_bbox_head=dict(
        ...
        with_circle_iou=False),  # with_circle_iou 是否输出预测的boxes的位置信息
    rot_head=dict(
        type='RotHeadPlus',
        in_channels=256,
        num_rot_bins=24,
