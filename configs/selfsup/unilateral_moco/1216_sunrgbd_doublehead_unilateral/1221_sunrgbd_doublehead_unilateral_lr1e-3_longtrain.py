...
runner = dict(type='IterBasedRunner', max_iters=49548+49548)  # 300 epoch
...
lr_config = dict(
    ...
    step=[33032+49548, 41290+49548])                         # 在第200epoch和250epoch时降低学习率
...
workflow = [('train', 1)]
gpu_ids = range(0, 1)
work_dir = 'newback/unilateral_moco/1217_sunrgbd_rot_and_loc_unilateral/1221_sunrgbd_rot_and_loc_unilateral_lr1e-3_longtrain'