...
work_dir = 'newback/ArbRotPlus/0517_ArbRotPlus_res50_2b8_lr_1e-1_100e_scratch_moco_locmcircle5_rot_rgd_dgr_aug12_type3_cosinelr'
...
model = dict(
    ...
    loc_bbox_head=dict(
        ...
        loss_circle=dict(with_circle_iou=True, loss_weight=5),
