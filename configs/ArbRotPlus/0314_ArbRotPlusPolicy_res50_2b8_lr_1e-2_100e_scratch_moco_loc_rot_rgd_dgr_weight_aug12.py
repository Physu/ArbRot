...
work_dir = 'newback/ArbRotPlus/0314_ArbRotPlus_res50_2b8_lr_1e-2_100e_scratch_moco_loc_rot_rgd_dgr_weight_aug12'
...
model = dict(
    ...
    loc_bbox_head=dict(
        ...
        in_channel=256,
        feat_channel=64,
        loss_center_heatmap=dict(type='GaussianFocalLoss', loss_weight=0.5),
        loss_wh=dict(type='L1Loss', loss_weight=0.05),
        loss_offset=dict(type='L1Loss', loss_weight=0.5)),
    rot_head=dict(
        type='RotHeadPlus',
        in_channels=256,
        num_rot_bins=24,
...
runner = dict(type='IterBasedRunnerWithEpoch', max_iters=2000, curriculum_speed=10, alpha_speed=10)
