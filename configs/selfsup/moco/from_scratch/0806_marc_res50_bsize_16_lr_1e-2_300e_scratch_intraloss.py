...
work_dir = 'newback/moco/from_scratch/0806_marc_res50_b16_lr_1e-2_300e_from_scratch_intraloss'
...
lr_config = dict(
    ...
    step=[19379*3, 29068*3, 116269]
)
# runner = dict(type='IterBasedRunner', max_iters=32297*2)
runner = dict(type='IterBasedRunner', max_iters=32297*3+32297)
