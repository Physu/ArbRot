...
work_dir = 'newback/ArbRotPlus/0413_ArbRotPlus_res50_2b8_lr_1e-1_100e_scratch_moco_loc_rot_rgd_dgr_type3_aug1234'
...
model = dict(
    ...
    loc_bbox_head=dict(
        ...
        output_flag=True),  # output_flag 是否输出预测的boxes的位置信息
    rot_head=dict(
        type='RotHeadPlus',
        in_channels=256,
        num_rot_bins=24,
        ...
        loss_total_weight=0.7),
    contrastive_head=dict(type='ContrastiveHead', temperature=0.2, loss_total_weight=0.3),
...
runner = dict(type='IterBasedRunner', max_iters=33032+1000)  # 两卡，bs=8，则100epoch iter为33032
