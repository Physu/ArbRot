rotation_num = None  # 相当于360任意旋转
num_rot_classes = 12
grid_num = 9
scale = None  # 相当于不设置任何障碍，直接就对其做一些旋转
# norm_cfg = dict(type='BN', requires_grad=True)
norm_cfg = dict(type='SyncBN', requires_grad=True)
dataset_type = 'SUNRGBDHHADataset'
data_root = 'data/sunrgbd/sunrgbd_trainval'
work_dir = 'newback/AMTCL_scale_ablation/0422_ArbRot_resnet50_bsize_32_lr_1e-3_100e_scale_2e-1_for_test'
...
data = dict(
    ...
    train=dict(
        ...
        pipeline=[
            ...
            dict(
                type='RotateCircleImgAndHHAArbRotPT',
                resize=256,
                angle=rotation_num,
                # grid=grid_num,
...
# # optimizer
# optimizer = dict(type='SGD', lr=0.004, weight_decay=1e-4, momentum=0.9)
