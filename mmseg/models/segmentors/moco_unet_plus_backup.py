...
class MoCoUnetDWAPlus(BaseSegmentor):
    """MOCO.
    ...
    def __init__(self,
                 ...
                 init_cfg=None,
                 **kwargs):
        super(MoCoUnetDWAPlus, self).__init__(init_cfg)
    ...
    def train_step(self, data_batch, optimizer, **kwargs):
        ...
        # loss2 = (losses['loc.loss_center_heatmap'] + losses['loc.loss_wh'] + losses['loc.loss_offset'])
        # loss3 = (losses['rot.rot_class_loss'] + losses['rot.rot_res_loss'])
        # loss4 = losses['rgd.loss_rgd_total']
        # loss5 = losses['dgr.loss_dgr_total']
        # # self.loss_t1 = self.loss_t2
        # # self.loss_t2 = [loss1, loss2, loss3, loss4, loss5]
        # # self.weights = self.dynamic_weight_average(self.loss_t1, self.loss_t2)
        # # print('weights:')
        # # print(self.weights)
    ...
    def dynamic_weight_average(self, loss_t_1, loss_t_2):
        ...
        lamb = [math.exp(v / self.T) for v in w]
