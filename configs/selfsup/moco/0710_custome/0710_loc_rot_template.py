...
work_dir = 'newback/moco/from_scratch/0710_marc_res50_b8_lr_1e-3_300e_loc_rot_template'
...
data = dict(
    ...
    val=dict(
        ...
        ann_dir='depth',
        label_dir='label',
        split='val_data_idx_backup_for_debug.txt',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadSUNRGBDAnnotations', keep_origin=True),
            dict(type='LoadSUNRGBDLabel'),
...
runner = dict(type='IterBasedRunner', max_iters=32297*2*3+40)
