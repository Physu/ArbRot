...
work_dir = 'newback/ArbRotPlusPolicy/0627_retrain_ArbRotPlusPolicy_res50_2b8_lr_1e-1_100e_scratch_byol_locm_rot_rgd_dgr_aug12_type2_cosinelr'
...
model = dict(
    ...
    work_dir=work_dir,
    policy_path='/data1/lhy/InfiRot/mmsegmentation/newback/ArbRotPlusPolicy/0621_ArbRotPlusPolicy_res50_2b8_lr_1e-1_100e_scratch_byol_locm_rot_rgd_dgr_aug12_type2_cosinelr/policy.pt'
)
data = dict(
    samples_per_gpu=3,
    workers_per_gpu=0,
...
runner = dict(type='IterBasedRunnerWithEpochForRetrain', max_iters=32297*2)
# curriculum_speed 是
# runner = dict(type='IterBasedRunner', max_iters=30000*4, curriculum_speed=1000, alpha_speed=200)
