...
def profile(
    ...
    # paste_location1 = torch.randn(1)
    # paste_location2 = torch.randn(1)
    # sunrgbd_rotation1 = torch.randn(1)
    # sunrgbd_rotation2 = torch.randn(1)
    ...
    #           'img': img}
    with torch.no_grad():
        model(*inputs, **kwargs)  # model(*inputs) 此处有修改
