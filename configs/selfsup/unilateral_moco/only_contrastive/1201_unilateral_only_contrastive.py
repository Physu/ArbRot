...
runner = dict(type='IterBasedRunner', max_iters=39642)
# learning policy
lr_config = dict(policy='CosineAnnealing', min_lr=0.)
# lr_config = dict(policy='Step', min_lr=0.)
...
workflow = [('train', 1)]
gpu_ids = range(0, 1)
work_dir = 'newback/1201_unilateral_grid3_rot4_only_contrastive_retrain/1201_unilateral_grid3_rot4'