...
model = dict(
    ...
    pretrained='/mnt/disk7/lhy/Cascade/mmsegmentation-0.14.1/newback/1123contrastive_rot/1123_unilateral_grid3_rot7_contrastive_rot/latest.pth',
    backbone=dict(
        type='ResNetV1c',
        depth=50,
        num_stages=4,
...
work_dir = 'newback/1129_unilateral_grid3_rot_contrastive_rot_downstream/1129_unilateral_grid3_rot7_contrastive_rot_fordownstream'
gpu_ids = range(0, 1)
