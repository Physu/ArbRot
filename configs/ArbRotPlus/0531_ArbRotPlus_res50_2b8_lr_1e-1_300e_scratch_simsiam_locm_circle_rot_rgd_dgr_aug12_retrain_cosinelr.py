...
work_dir = '/data1/lhy/newback/ArbRotPlus/0526_ArbRotPlus_res50_2b8_lr_1e-1_100e_scratch_simsiam_locm_circle_rot_rgd_dgr_aug12_retrain_cosinelr'
...
model = dict(
    ...
    loc_bbox_head=dict(
        ...
        loss_circle=dict(with_circle_iou=True, loss_weight=1.)),  # output_flag 是否输出预测的boxes的位置信息
    rot_head=dict(
        type='RotHeadPlus',
        in_channels=256,
        num_rot_bins=24,
...
checkpoint_config = dict(interval=33032//2)
