...
work_dir = 'newback/ArbRotPlus/0305_ArbRotPlus_res50_2b8_lr_1e-1_100e_scratch_moco_loc_rot_rgd_dgr.py'
...
runner = dict(type='IterBasedRunnerWithEpoch', max_iters=33032, curriculum_speed=3)  # 两卡，bs=8，则100epoch iter为33032
