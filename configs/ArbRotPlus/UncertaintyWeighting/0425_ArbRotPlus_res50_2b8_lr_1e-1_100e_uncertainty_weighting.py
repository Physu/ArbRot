...
work_dir = 'newback/ArbRotPlus/0425_ArbRotPlus_res50_2b8_lr_1e-1_100e_uncertainty_weighting'
...
img_norm_cfg = dict(
    ...
    to_rgb=True)
model = dict(
    type='MoCoUnetUncertaintyWeightingPlus',
    queue_len=65536,
    feat_dim=128,
    momentum=0.999,
    backbone=dict(
    ...
    rot_head=dict(
        ...
        loss_total_weight=1.0*0.6),
    contrastive_head=dict(type='ContrastiveHead', temperature=0.2, loss_total_weight=0.5*0.4),
