...
work_dir = 'newback/moco/from_scratch/1026_marc_res50_8b8_lr_1e-1_600e_from_scratch_simclr_loc_rot_rgd_dgr'
...
model = dict(
    ...
    contrastive_head=dict(type='ContrastiveHead', temperature=0.1, loss_total_weight=0.2),
