...
work_dir = 'newback/ArbRotPlusPolicy/0629_ArbRotPlusPolicy_res50_2b8_lr_1e-1_100e_scratch_simsiam_locm_rot_rgd_dgr_aug12_type2_cosinelr'
...
# optimizer
optimizer = dict(type='SGDPolicy', lr=0.001, weight_decay=1e-4, momentum=0.9)
