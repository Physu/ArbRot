...
work_dir = 'newback/ArbRotPlus/0401_ArbRotPlus_res50_2b8_lr_1e-1_100e_scratch_moco1e-1_loc'
...
model = dict(
    ...
    contrastive_head=dict(type='ContrastiveHead', temperature=0.2, loss_total_weight=0.05),
